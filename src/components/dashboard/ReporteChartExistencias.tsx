...
const ReporteChartExistencias: React.FC<ReporteChartExistenciasProps> = ({
  data,
}) => {
  ...
  return (
    <div className="flex">
      ...
      <div className="w-1/5 p-4">
        {" "}
        {/* Ajusta el ancho de la columna según necesites */}
      ...
      <div className="w-4/5 p-4">
        {" "}
        {/* Flex-1 para que tome el resto del espacio */}
