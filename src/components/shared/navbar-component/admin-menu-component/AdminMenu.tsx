  ...
  <div className="mt-4">
    ...
    <ul className="flex flex-col gap-1">
      <li className="flex items-center gap-4 hover:text-blue-500 hover:bg-slate-50 p-2 rounded-xl">
        ...
        <Link className="text-sm" href="/admin/products">Productos</Link>
      </li>
      <li className="flex items-center gap-4 hover:text-blue-500 hover:bg-slate-50 p-2 rounded-xl">
        <FaUsers className="text-2xl" />
        <Link className="text-sm" href="/admin/users">Usuarios</Link>
      </li>
      <li className="flex items-center gap-4 hover:text-blue-500 hover:bg-slate-50 p-2 rounded-xl">
        <FaBagShopping className="text-2xl" />
        <Link className="text-sm" href="/admin/orders">Pedidos</Link>
      </li>
    </ul>
  </div>
);
